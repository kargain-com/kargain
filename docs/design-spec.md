...
*Document version: 5.109 (August 2026 — Write-path tx errors name SourceUnanswerable source via shared ABI decode). Update when tokens, app shell, or component contracts change.*