...
*Document version: 5.104 (July 2026 — Outstanding obligations: profile tab + commerce notification feed share `lib/obligation/` derivation). Update when tokens, app shell, or component contracts change.*