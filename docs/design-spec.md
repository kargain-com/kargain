...
*Document version: 5.121 (August 2026 — §4.19 bridge indexer catch-up completes via `useTxSync.syncReads`). Update when tokens, app shell, or component contracts change.*