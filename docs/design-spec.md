...
*Document version: 5.36 (July 2026 — passive Nostr pubkey restore via attested kind 0 relay lookup). Update when tokens, app shell, or component contracts change.*