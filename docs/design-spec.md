...
*Document version: 5.107 (August 2026 — Delegated vehicles show granted terms; Commission live FixedPrice owner proceeds). Update when tokens, app shell, or component contracts change.*