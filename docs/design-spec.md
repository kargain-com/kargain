...
*Document version: 5.122 (August 2026 — §4.11 profile Listings = seller live consignments / OPEN_PHASES). Update when tokens, app shell, or component contracts change.*