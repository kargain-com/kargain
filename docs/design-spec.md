...
*Document version: 5.16 (July 2026 — KP-3b.1 profile edit fail-closed lud16 gating while verifier status resolves). Update when tokens, app shell, or component contracts change.*