...
*Document version: 5.110 (August 2026 — Four known facts at action sites: settlement-note permanence, verification withdraw record, protection trade, frozen remainder). Update when tokens, app shell, or component contracts change.*