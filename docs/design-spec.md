...
*Document version: 5.106 (August 2026 — Passport edit refusals name the cause; `notFound` only when absent). Update when tokens, app shell, or component contracts change.*