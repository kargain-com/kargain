...
*Document version: 5.15 (July 2026 — KP-4 verifier directory search v2: extended client search, Lowest fee sort, results counter). Update when tokens, app shell, or component contracts change.*