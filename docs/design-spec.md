...
*Document version: 5.31 (July 2026 — profile edit KarPro readout group with per-section deep links). Update when tokens, app shell, or component contracts change.*