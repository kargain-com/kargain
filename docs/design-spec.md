...
*Document version: 5.53 (July 2026 — Vincent F-2.1 document-based WMI claim proposals in the Commons queue). Update when tokens, app shell, or component contracts change.*