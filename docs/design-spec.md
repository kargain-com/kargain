...
*Document version: 5.80 (July 2026 — §4.17 verifiers discovery filtered by commercial-union chain active). Update when tokens, app shell, or component contracts change.*