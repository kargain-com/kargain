...
*Document version: 5.29 (July 2026 — KarPro Account → Membership section; legacy `?section=account` alias). Update when tokens, app shell, or component contracts change.*