...
*Document version: 5.54 (July 2026 — Vincent F-2.2 Commons governance readouts: publishers panel, pinned dataset card, role explainer). Update when tokens, app shell, or component contracts change.*