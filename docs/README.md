...
| Document | Purpose |
|----------|---------|
| [design-spec.md](./design-spec.md) | UI layout, tokens, components — Instrument Layer §10–§13; passport detail mobile quick-nav/sheets + desktop MRZ strip / featured comment teaser (§4.14, §13.6–§13.7) |
