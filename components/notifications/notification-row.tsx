...
const ICON_BY_TYPE: Record<NotificationType, IconComponent> = {
  ...
  "commerce.bid_refunded": CreditCardIcon,
  "commerce.settled": CircleInformationIcon,
  "commerce.challenge_opened": ShieldWarningIcon,
  "commerce.challenge_judged": ShieldIcon,
  "commerce.challenge_concluded": CircleInformationIcon,
  "commerce.reversal_started": WarningIcon,
  "commerce.recall_force_ready": CircleInformationIcon,
  "commerce.mode_paused": WarningIcon,
  "commerce.protection_closing": CircleInformationIcon,
  "commerce.reversal_deadline_approaching": WarningIcon,
  "commerce.challenge_window_closing": ShieldWarningIcon,
