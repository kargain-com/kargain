...
echo "  5. docker image prune -f"
echo "  6. docker builder prune -f --filter until=72h"
echo "  7. After sync: keep the same numeric start block (do NOT set latest on Ponder 0.16)"
echo "  8. Watch logs: docker compose logs -f ponder"
